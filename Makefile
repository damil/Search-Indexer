# This Makefile is for the Search::Indexer extension to perl.
#
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Search/Indexer.pm
...
PM_TO_BLIB = lib/Search/indexer.txt \
...
Indexer.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Search::Indexer\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Search/Indexer.pm $(INST_MAN3DIR)\Search.Indexer.$(MAN3EXT) 
